       ...
       <div className="max-w-6xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 leading-tight">
            Explore{' '}
            <span className="text-[#4c735d]">Islam</span>
          </h2>
        </motion.div>
         ...
         <motion.p
           ...
           variants={textVariants}
         >
           Step into the spiritual essence of Islam through sound, sight, and sacred space. This section invites you to not just learn about Islam — but to feel it.
         </motion.p>
        ...
        >
         ...
         >
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            The Adhān is more than a call — it&apos;s a living rhythm of faith that encircles the globe. As it ends in one city, it begins in the next, creating a continuous wave of remembrance that never leaves the earth silent. Hear its beauty and experience the unity it represents.
          </p>
         </motion.div>
         ...
         <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 mt-12 sm:mt-16">
           ...
           >
             ...
             <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
               Immerse yourself in the timeless words of Allah, recited with beauty, clarity, and deep emotion. Every verse offers a message of guidance, peace, and reflection.
             </p>
           </motion.div>
