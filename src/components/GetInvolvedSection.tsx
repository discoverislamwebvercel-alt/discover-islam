        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-auto lg:h-[470px] max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <button className="bg-black text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-base sm:text-lg hover:bg-gray-800 transition-colors duration-300">
                Fill out form
              </button>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <div className="flex justify-start">
                <button className="bg-white text-black px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-base sm:text-lg hover:bg-gray-200 transition-colors duration-300">
                  Fill out form
                </button>
              </div>
            </motion.div>
